...
class Wangsta extends Wangsta_Base {
    ...
    public function __construct( $realm_id, $realm, $MI3Coords = array(), $uid, $wgangsta, $hoods )
    {
        ...
        $this->realm = $realm;
				...
				sleep(3); // to avoid simultanious curls to api
    ...
    */
    ...
    public function set_troops( $units = null )
    {
        if ( is_array( $units ) )
        {
            ...
            $units = '{"Romeo":15000, "Bassist":15000,"Skinner":5000,"ManEater":15000,"FrontMan":28000,"MisterSnip":775,"Sniper":25}';
				}
        $this->_troops = $units;
        return $this;
    }
...
$gangsta = new Wangsta ( $realm_id, $realm, $MI3Coords, $uid, $wgangsta, $hoods );
