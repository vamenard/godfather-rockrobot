...
class Wangsta extends Wangsta_Base {
     ...
     */
    public function __construct( $realm_id, $realm, $MI1Coords, $uid, $wgangsta, $hoods )
    {
    ...
    public function set_troops( $units = null )
    {
        if ( is_array( $units ) )
        {
            $units = json_encode( $units );
						...
						$units = '{"DeliveryBomber":1200,"CarBomber":2000,"Bonnie":1000,"Romeo":1000,"MisterSnip":1,"FreightTrain":100}';
				}
        $this->_troops = $units;
        return $this;
    }
...
$gangsta = new Wangsta ( $realm_id, $realm, $MI1Coords, $uid, $wgangsta, $hoods );
// ma troops sent
/*
	$units = array(
		"Romeo" => 5000,
