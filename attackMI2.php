...
class Wangsta extends Wangsta_Base {
     ...
     */
    public function __construct( $realm_id, $realm, $MI2Coords, $uid, $wgangsta, $hoods )
    {
    ...
    */
    ...
    public function set_troops( $units = null )
    {
        if ( is_array( $units ) )
        {
            ...
            $units = '{"Bassist":11000,"Skinner":8000,"ManEater":6000,"FrontMan":5000,"DeliveryBomber":1000,"MisterPao":2000,"MisterKippy":1000,"MisterFixit":320,"MissesNeat":3000,"MisterSplit":12000,"MisterSnip":12000,"Romeo":10000,"Sniper":10}';
				}
        $this->_troops = $units;
        return $this;
    }
