...
class Wangsta extends Wangsta_Base {
        ...
        {
                $url = "http://realm184.c2.godfather.rykaiju.com/api/map.json?";
                $data = array(
                        'x' => $cords['x'],
        ...
        public function set_troops( $units = null )
        {
                if ( is_array( $units ) )
                {
						...
						if ($_GET['hood'] == 1) {
							$units = '{"DeathSquad":5000,"HatchetMan":2000,"DeliveryTruck":300,"Smuggler":1000}';
						} else {
							$units = '{"Romeo":200,"FrontMan":200,"Bassist":180,"DeliveryTruck":260}';
						}
				}
                $this->_troops = $units;
                return $this;
